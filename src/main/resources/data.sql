insert into article(id, title, content) values(1, '1111', '1111');
insert into article(id, title, content) values(2, '2222', '2222');
insert into article(id, title, content) values(3, '3333', '3333');

----article 더미 데이터
--insert into article(id, title, content) values(4, '당신의 인생 영화는?', '댓글ㄱㄱ');
--insert into article(id, title, content) values(5, '당신의 소울 푸드는?', '댓글ㄱㄱ');
--insert into article(id, title, content) values(6, '당신의 취미는?', '댓글ㄱㄱ');
--
----comment 더미 데이타
------ 4번 게시글의 댓글
